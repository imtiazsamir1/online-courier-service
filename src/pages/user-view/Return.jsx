...
const Return = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    <div className="text-center lg:text-left">
      <h1 className="text-5xl font-bold">Product Return</h1>
      <p className="py-6">
      30% Charge above return product
      </p>
    </div>
      ...
      <form className="card-body">
        <div className="form-control">
          <label className="label">
            <span className="label-text">Descrive why you return product.</span>
          </label>
          <textarea
  placeholder="Descrive"
